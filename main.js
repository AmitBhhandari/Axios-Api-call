//AXIOS GLOBALS
axios.defaults.headers.common['X-Auth-Token'] = 'k4kv8RZ8QAd06Rid169mjG6BuY5tqrtQ';
...
function errorHandling() {
  ...
  axios
    .get('https://jsonplaceholder.typicode.com/todoss',{
      // ValidityStates:function(status){
...
document.getElementById('cancel').addEventListener('click', cancelToken);ii